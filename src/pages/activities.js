                    ...
                    <CardHeader>
                        <Stack anchor="center">
                            ...
                            <Box align="center" pad="none" width="100vw">
                                <Text color="light-1" size="2xl">Golf Tournament</Text>
                            </Box>
                        </Stack>
                    </CardHeader>
                    <CardBody>
                ...
                <Card background="light-1">
                    <CardHeader>
                        <Stack anchor="center">
                            ...
                            <Box align="center" pad="none" width="100vw">
                                <Text color="light-1" size="2xl">Fishing Tournament</Text>
                            </Box>
                        </Stack>
                    </CardHeader>
                    <CardBody>
                ...
                <Card background="light-1">
                    <CardHeader>
                        <Stack anchor="center">
                            ...
                            <Box align="center" pad="none" width="100vw">
                                <Text color="light-1" size="2xl">Cornhole Tournament</Text>
                            </Box>
                        </Stack>
                    </CardHeader>
                    <CardBody>
                ...
                <Card background="light-1">
                    <CardHeader>
                        <Stack anchor="center">
                            ...
                            <Box align="center" pad="none" width="100vw">
                                <Text color="light-1" size="2xl">Horseshoe Tournament</Text>
                            </Box>
                        </Stack>
                    </CardHeader>
                    <CardBody>
        ...
        <Grid
            ...
            <StyledAct2>
                <Stack anchor="center">
                    ...
                    <Box align="center" pad="none" width="100vw">
                        <Text color="light-1" size="xl">Frisbee Golf</Text>
                    </Box>
                </Stack>
            </StyledAct2>
            ...
            <StyledAct4 >
                <Stack anchor="center">
                    ...
                    <Box align="center" pad="none" width="100vw">
                        <Text color="light-1" size="xl">Archery</Text>
                    </Box>
                </Stack>
            </StyledAct4>
        </Grid>
